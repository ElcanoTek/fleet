...
It lives at the repository root because that is where Claude Code's
`/team-onboarding` writes and its share tool reads an `ONBOARDING.md`; every
other page of this kind is under [`docs/`](docs/README.md).
