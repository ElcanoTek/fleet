...
# binary and unit files regardless of the caller's cwd (`fleet bootstrap` invokes it
...
# the operator CLI reads them from the SAME 0600 file deploy/fleet.service EnvironmentFiles.
