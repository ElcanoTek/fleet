...
func TestDownloadURL_FilenameFromContentDisposition(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
		w.Header().Set("Content-Disposition", `attachment; filename="ACME_KOC_ABC.xlsx"`)
	...
	if !strings.HasPrefix(res.Filename, "ACME_KOC_ABC__") || !strings.HasSuffix(res.Filename, ".xlsx") {
