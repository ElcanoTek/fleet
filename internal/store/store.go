...
func (s *Store) TruncateAllForTest(ctx context.Context) error {
	_, err := s.db.ExecContext(ctx,
		`TRUNCATE TABLE conversations, memories, memory_entities, users, panic_events, remote_mcp_servers, push_subscriptions, llm_providers, workspace_settings RESTART IDENTITY CASCADE`)
	return err
}
