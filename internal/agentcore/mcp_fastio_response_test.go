...
- **summary:**
  ...
  - **long:**
    ...
    Across the dataset, a variety of campaigns are tracked, including those with "EXCO_GUM_PMP_DEMO_OLV", "EXCO_MGNTE_PMP_DEMO_CTV", "EXCO_MGNTE_PMP_DEMO_OLV", "EXCO_ROKU_PMP_DEMO_CTV", "EXCO_Example Partner_PMP_DEMO_CTV", and "Example_Magnite" identifiers.
...
func TestTrimFastIOResponse_SearchStripsBuildHashAndNext(t *testing.T) {
	...
	for _, keep := range []string{
		"# files",
		"ACME_KOC_Example Agency_ABC Plumbing_ELC00109.xlsx",
		"# pagination",
