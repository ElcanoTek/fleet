...
THEMES = {
    "light": dict(ink="#1f2328", text="#1f2328", muted="#59636e",
                  brace_top="#848d97", brace_bot="#59636e",
                  fill_op="0.16", stroke_op="0.5"),
    "dark": dict(ink="#e6edf3", text="#e6edf3", muted="#9198a1",
                 brace_top="#767d86", brace_bot="#9198a1",
                 fill_op="0.22", stroke_op="0.6"),
}

ACCENTS = ["#3b82f6", "#10b981", "#8b5cf6", "#f59e0b", "#f43f5e", "#06b6d4",
           "#8b5cf6", "#3b82f6", "#f59e0b", "#10b981", "#f43f5e", "#06b6d4"]
...
def sparkle(cx, cy, r):
    ...
    k = r * 0.14
    return (f'<path d="M {cx} {cy - r} C {cx + k} {cy - k * 2} {cx + k * 2} {cy - k} {cx + r} {cy} '
...
GLYPHS = [
    ...
    '<path d="M -3 9 V 13 C -3 18.5 -13 17 -13 22"/>'
    + sparkle(13, -12, 6),
