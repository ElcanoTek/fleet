...
| V4 | `docs_url` answers 403 to a plain GET from the audit box for Coda (Leonardo.Ai's 500 on 2026-09-16 was transient — 200 since); ZoomInfo's is a real 404 (already noted) | Coda looks like a bot wall, re-check from a browser; ZoomInfo needs a new link |
