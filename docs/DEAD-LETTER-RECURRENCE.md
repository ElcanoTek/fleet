...
occurrence exists in the same chain. If the dead-letter already spawned
(or the lineage continued after the immediate successor was pruned),
replay re-runs that occurrence and cannot fork a second chain.
